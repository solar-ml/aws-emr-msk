...
As of Feb 17, 2023 AWS Step Functions adds integration for 35 services including EMR Serverless. Amazon press release mentions that 
...
This means that in future iterations of this workflow, StepFunctions will be able to launch EMR serverless jobs directly, without using Lambda functions as an intermediary.
